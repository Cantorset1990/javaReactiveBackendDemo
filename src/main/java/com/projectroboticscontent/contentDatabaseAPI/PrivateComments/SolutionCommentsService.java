...
public class SolutionCommentsService {
   ...
   // private ReactiveMongoTemplate MongoOps;
    ...
    private Mono<String> newComment(String token, String USERTYPE,
                            String  COMMENT_DATA,
    ...
    private Mono<String> newCommentSolutionProvider(String token, String USERTYPE,
                             String  COMMENT_DATA,
                             long PRIMARY_KEY_SOLUTION,long COMMENT_ID, long SOLUTION_ID,
    ...
    private Mono<String> newCommentUser(String token, String USERTYPE,
                                String  COMMENT_DATA,
    ...
    private Mono<String> newSubmissionSolutionProvider(String token, String USERTYPE,
                              String COMMENT_DATA,
    ...
    private Mono<String> newSubmissionUser(String token, String USERTYPE,
                                              String COMMENT_DATA,
                                              long SOLUTION_ID, long FORM_ID)
    {
    ...
    public Mono<String> newFinalSubmissionSolutionProvider(String token, String USERTYPE,
                                              String COMMENT_DATA,
                                              long SOLUTION_ID)
    {
        final Query query =
    ...
    public Mono<String> newFinalSubmissionUser(String token, String USERTYPE,
                                  String COMMENT_DATA,
                                  long SOLUTION_ID)
    {
        final Query query =
    ...
    public Flux<CommentStorage> getAllSolutionComments(String token, String USERTYPE, long SOLUTION_ID ){
