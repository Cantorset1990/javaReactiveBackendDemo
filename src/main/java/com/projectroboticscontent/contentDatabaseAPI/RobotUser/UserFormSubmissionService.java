...
public class UserFormSubmissionService {
    ...
    private Mono<String> newForm(String token, String USERTYPE, String FORM_TITLE, String JSON_FORM_DATA,
    ...
    private Flux<Document> newForm(String token, String USERTYPE, String FORM_TITLE, String JSON_FORM_DATA,
    ...
    public Mono<String> newSubmission(String token, String USERTYPE, String FORM_TITLE, String JSON_FORM_DATA)
    {
    ...
    public Flux<Document> newSubmission(String token, String USERTYPE, String FORM_TITLE, String JSON_FORM_DATA,
