...
public class FinanceSubmission extends FinanceRequest{
    ...
    public FinanceSubmission(long STATUS, long FINANCE_REQUEST_ID, long TOTAL_COST,
        ...
        super(STATUS, FINANCE_REQUEST_ID, TOTAL_COST, SOLUTION_TITLE, PAYMENT, USAGE_TIME, SOLUTION_PROVIDER_PRIMARY_KEY, INVESTOR_PRIMARY_KEY,
