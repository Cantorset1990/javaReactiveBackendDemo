...
public class AddTransactionServiceStatic {
    ...
    //private static final MongoClient setBlockClient = MongoClients.create();;
    //private static final ReactiveMongoTemplate setBlockMongoOps = ;


    private static Mono getbalance(String WALLET_ID)
    {
    ...
    private static Mono AddTransaction(String RECEIVER_WALLET_ID, String SENDER_WALLET_ID, long RECEIVER_TRANSACTION_AMOUNT,
    ...
    private static Mono AddTransaction2(String RECEIVER_WALLET_ID, String SENDER_WALLET_ID, long RECEIVER_TRANSACTION_AMOUNT,
    ...
    public static Mono AddTransaction3(String RECEIVER_WALLET_ID, String SENDER_WALLET_ID,
    ...
    public static Mono AddTransaction4(String token, String USERTYPE, String RECEIVER_WALLET_ID,
                                       long TRANSACTION_AMOUNT, long PROPERTY)
    {
