...
public class PrivateFileController {
    ...
    @PostMapping(value = "/api/private/solution/file/submit",  consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @CrossOrigin({"http://localhost:3000", "http://localhost:8080"})


    public Mono<String> solutionFileSubmission(@RequestBody PrivateFileStorage submission) {
    ...
    @PostMapping(value = "/api/private/user/file/submit",  consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @CrossOrigin({"http://localhost:3000", "http://localhost:8080"})


    public Mono<String> userFileSubmission(@RequestBody PrivateFileStorage submission) {
    ...
    @PostMapping(value = "/api/private/files/user/get",  consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @CrossOrigin({"http://localhost:3000", "http://localhost:8080"})


    public Flux<PrivateFileInfo> getAllCommentsByUser(@RequestBody PrivateFileStorage submission) {
    ...
    @PostMapping(value = "/api/private/files/solution/get",  consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @CrossOrigin({"http://localhost:3000", "http://localhost:8080"})


    public Flux<PrivateFileInfo> getAllCommentsByProvider(@RequestBody PrivateFileStorage submission) {
    ...
    @PostMapping(value = "/api/private/file/user/get",  consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @CrossOrigin({"http://localhost:3000", "http://localhost:8080"})


    public Mono<PrivateFileStorage> getOneFileByUser(@RequestBody PrivateFileStorage submission) {
    ...
    @PostMapping(value = "/api/private/file/solution/get",  consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @CrossOrigin({"http://localhost:3000", "http://localhost:8080"})


    public Mono<PrivateFileStorage> getOneFileBySolutionProvider(@RequestBody PrivateFileStorage submission) {
